...
internal class InitialData
{
    ...
    new List<Customer>
    {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "nemanja", "nemanja@gmail.com"),
        Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "dusan", "dusan@gmail.com")
    };
    ...
    public static IEnumerable<Product> Products =>
        new List<Product>
        {
            ...
            Product.Create(ProductId.Of(new Guid("6ec1297b-ec0a-4aa1-be25-6726e3b51a27")), "Xiaomi Mi", 470),
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("nemanja", "nikolic", "nemanja@gmail.com", "Vojvode Putnika 4", "Serbia", "Nis", "18000");
            var address2 = Address.Of("dusan", "savic", "dusan@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");

            var payment1 = Payment.Of("nemanja", "5555555555554444", "12/28", "355", 1);
            var payment2 = Payment.Of("dusan", "8885555555554444", "06/30", "222", 2);
